...
function mp_profit_enqueue() {
	if ( is_callable( 'is_customize_preview' ) && is_customize_preview() ) {
		wp_enqueue_script( 'mp-profit-sections', get_template_directory_uri() . '/js/theme-sections.min.js', '', mp_profit_get_theme_vertion(), true );
	}
}
...
function mp_profit_scripts_styles() {
	...
	wp_enqueue_script( 'mp-profit-script', get_template_directory_uri() . '/js/profit.min.js', array(
		...
		'superfish.min',
		'flexslider'
	), mp_profit_get_theme_vertion(), true );
	...
	wp_localize_script( 'mp-profit-script', 'template_directory_uri', $translation_array );
	...
	wp_enqueue_style( 'mp-profit-main', get_template_directory_uri() . '/css/profit-style.min.css', array(
		'bootstrap',
		'font-awesome'
	), mp_profit_get_theme_vertion(), 'all' );
	 ...
	 */
	wp_enqueue_style( 'mp-profit-style', get_stylesheet_uri(), array(), mp_profit_get_theme_vertion() );
}
 ...
 * @return string
 */
function mp_profit_get_theme_vertion() {
