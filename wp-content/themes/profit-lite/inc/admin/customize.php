...
// Brand Color
	...
	function customize_preview_js() {
		wp_enqueue_script( $this->getPrefix() . 'customizer', get_template_directory_uri() . '/js/theme-customizer.min.js', array( 'customize-preview' ), mp_profit_get_theme_vertion(), true );
	}
